...
//        return createMockReport(ReportStatus.PENDING, "POST", 10L);
//    }
//
//    /**
...
//        return createMockReport(ReportStatus.PENDING, "COMMENT", 20L);
//    }
//
//    /**
...
//        return createMockReport(ReportStatus.RESOLVED, "POST", 10L);
//    }
//
//    /**
...
//        return createMockReport(ReportStatus.REJECTED, "POST", 10L);
//    }
//
//    // ── 신고 Report 목 생성 헬퍼 ─────────────────────────────────
//    private Report createMockReport(ReportStatus status, String type, Long targetId) {
...
//                given(reportRepository.findAllByStatus(ReportStatus.PENDING, pageable)).willReturn(reportPage);
//
//                // when
//                Page<ReportResponseDTO> result = adminReportService.getReports(ReportStatus.PENDING,pageable);
//
//                // then
...
//                given(reportRepository.findAllByStatus(ReportStatus.PENDING, pageable)).willReturn(Page.empty());
//
//                // when
//                Page<ReportResponseDTO> result = adminReportService.getReports(ReportStatus.PENDING,pageable);
//
